...
{
    class BTConditionCompareScore: BTConditionBase
    {
        ...
        public BTConditionCompareScore():
            base()
        {
            ...
            value = 1;
            nodeName = "CompareScore";
            nodeDestricption = "对球的得分进行比较.当compareType为AbsoluteValue时，若purpose的分数大于value，则返回成功;当compareType为RelativeMultiplier时，若purpose与source的分数比率大于value，则返回成功";
        }
